package com.levelUpToast.levelUpToast.rest.main;
...
import com.levelUpToast.levelUpToast.service.main.SimpleMainService;
...
public class MainPageController {
    ...
    public MainPageResponseForm loggedMainPage(@PathVariable("token") String token) {
        try {
            ...
            return new MainPageResponseForm(-1, "로그인 완료된 MainPage", simpleMainService.mainPage(findMem.get()));
