...
public class SimpleMailService implements MailService {
    ...
    private final Map<String, String> codeStore =
            ExpiringMap.builder()
                    .maxSize(1000)
                    .expirationPolicy(ExpirationPolicy.CREATED)
                    .expiration(3, TimeUnit.MINUTES)
                    .expirationListener(
                    (mail, code) -> log.info("[MailService log] : 메일 인증 코드 시간 만료 제거, mail = {}, code = {} ", mail, code)
            ).build();
    ...
    private void expireCode(String userMail) {
