...
public class SimpleSignUpService implements SignUpService {
    ...
    public Member signUp(SignUpRequestForm form) throws LevelUpToastEx {
        ...
        Member member = new Member(form.getId(), form.getPw(), Authority.MEM, form.getName(), form.getBirth(), form.getGender(), form.getPhoneNumber(), form.getE_mail(), form.getAddress());
